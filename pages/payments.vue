<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Payments & Revenue</h1>
        <p class="text-sm text-gray-500 mt-1">Track transactions and subscription payments.</p>
      </div>
      <div class="flex items-center gap-3">
        <button class="px-4 py-2 text-sm font-medium bg-white border border-gray-300 text-gray-700 rounded hover:bg-gray-50 transition-colors">
          Export CSV
        </button>
        ...
        <div v-for="payment in payments" :key="payment._id" class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden flex flex-col">
          <div class="p-5 flex-1">
            <div class="flex items-center justify-between mb-4">
              <span class="text-2xl font-black text-gray-900">${{ payment.amount }}</span>
