<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Vault Management</h1>
...
const { loading, deleting, uploadProgress, resources, filters, total, totalPages, getResources, uploadResource, deleteResource } = useManageVault();
